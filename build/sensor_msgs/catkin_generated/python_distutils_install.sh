...
echo_and_run cd "/home/ubuntu/catkin_ws/src/sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/catkin_ws/src/sensor_msgs/setup.py" \
     \
    build --build-base "/home/ubuntu/catkin_ws/build/sensor_msgs" \
    install \
    --root="${DESTDIR-/}" \
